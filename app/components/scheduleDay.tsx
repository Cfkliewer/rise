...
export const ScheduleDay: FC<Props> = ({ day, custom }) => {
	...
	const get615 = () => {
		switch (day) {
			...
			case "M":
				return <div className="text-stone-900 text-xl xl:text-2xl 2xl:text-3xl  py-1">6:15 p.m. (Workout of the Day)</div>
			default:
				return;
	...
	const get6am = () => {
		switch (day) {
			...
			case "W":
			case "F":
				return <div className="text-stone-900 text-xl xl:text-2xl 2xl:text-3xl  py-1">6:00 a.m. (Workout of the Day)</div>
			default:
				return;
	...
	const get515 = () => {
		switch (day) {
			...
			default:
				return <div className="text-stone-900 text-xl xl:text-2xl 2xl:text-3xl  py-1">5:15 p.m. (Workout of the Day)</div>
		}
	}
	...
	if (day === "S") {
		return (
			<motion.div
				...
				className="p-4 flex items-center flex-col min-h-[19em]">
				<div className="text-stone-900 text-xl xl:text-2xl 2xl:text-3xl  py-1">8:15 a.m. (Workout of the Day)</div>
	...
	return (
		<motion.div
			...
			className="p-4 flex items-center flex-col min-h-[19em]">
			<div className="text-stone-900 text-xl xl:text-2xl 2xl:text-3xl  py-1">5:00 a.m. (Workout of the Day)</div>
			{get6am()}
			<div className="text-stone-900 text-xl xl:text-2xl 2xl:text-3xl  py-1">12:00 p.m. (Workout of the Day)</div>
